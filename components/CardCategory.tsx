...
const getIcon = (name: string): LucideIcon => {
  const iconMap: Record<string, LucideIcon> = {
    "pertanian": Icons.Sprout,
    "accessories": Icons.Gem,
    "lainnya": Icons.Box,
    "makanan": Icons.Utensils,
    "laptop": Icons.Laptop,
    "minuman": Icons.CupSoda,
    "default": Icons.LayoutGrid, // Icon cadangan jika tidak cocok
  }

  return iconMap[name.toLowerCase()] || iconMap["default"]
}

export function CategoryCard({ name, icon_url }: { 
  name: string
  icon_url?: string
}) {
